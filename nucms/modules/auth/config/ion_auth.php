...
*/
$config['tables']['users']           = 'nu_user';
$config['tables']['groups']          = 'nu_group';
$config['tables']['users_groups']    = 'nu_user_group';
$config['tables']['login_attempts']  = 'nu_login_attempt';
 ...
 */
$config['site_title']                 = 'nucms';       // Site Title, example.com
$config['admin_email']                = "admin@nucms.com";   // Admin Email, admin@example.com
